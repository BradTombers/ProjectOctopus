...
from .assets import metrics, trips, requests, fakerapi
...
fakerapi_assets = load_assets_from_modules([fakerapi])
...
defs = Definitions(
    assets=[*trip_assets, *metric_assets, *request_assets, *fakerapi_assets],
    resources={
